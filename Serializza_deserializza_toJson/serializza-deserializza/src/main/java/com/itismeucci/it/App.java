...
{ 
    private static void serializza(Classe c){
        ...
        try {
            objectMapper.writeValue(new File ("miaclasse.json"), c);
        } catch (Exception e) {
    ...
    private static Classe deserializza(String nomeFile){
        ...
        ObjectMapper objectMapper = new ObjectMapper();
        try {
            miaClasse = objectMapper.readValue(new File(nomeFile), Classe.class);
        } catch (Exception e) {
    ...
    public static void main( String[] args )
    {
        ...
        Classe classe_ritornata = deserializza("miaclasse.json");
